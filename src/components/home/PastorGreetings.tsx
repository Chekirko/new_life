  ...
  return (
    <section className="relative overflow-hidden bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        {/* RIGHT: text */}
        <div>
          <h6 className="text-green-600 font-semibold mb-2">About us</h6>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Your technical partner towards web success.
          </h2>
          <p className="text-lg text-gray-600 mb-4">
            Our friendly team members are always willing to help you understand
            your present technology requirements and provide suggestions on your
            future needs.
          </p>
          <p className="text-gray-600 mb-6">
            Additions can suspected its concealed put furnished. Met the why
